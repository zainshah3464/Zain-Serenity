...
export default function LocationMap() {
  ...
  // Smooth out scroll progress using spring for lag-free parallax
  ...
  const handleMapClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    window.open(
      "https://www.google.com/maps/place/19%C2%B059'00.0%22S+57%C2%B036'00.0%22E/@-19.9833333,57.5974197,798m/data=!3m2!1e3!4b1!4m4!3m3!8m2!3d-19.9833333!4d57.6?authuser=0&entry=ttu&g_ep=EgoyMDI2MDgwNS4xIKXMDSoASAFQAw%3D%3D",
      "_blank"
    );
  };
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-b from-teal-50/30 to-white"
    >
      {/* Background decorative shapes – faster animations */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <motion.p
          ...
          className="text-center text-gray-500 max-w-2xl mx-auto mb-12 md:mb-16 text-sm md:text-base"
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          >
            ...
            {/* Floating map pin with double pulse – faster animation */}
          ...
          <motion.div
            ...
            className="bg-white/40 backdrop-blur-xl border border-white/50 rounded-3xl p-7 md:p-10 shadow-xl hover:shadow-2xl transition-shadow duration-200"
          >
            <h3 className="text-2xl font-['Playfair_Display',serif] font-bold text-gray-800 mb-6 flex items-center gap-3">
              <motion.div
